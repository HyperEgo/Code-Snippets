...
public class Dayz implements Serializable {
    ...
    public void setPurchaseNodePrice(String d, int y) {
        Purchase pu = (Purchase) this.purchaseList.get(y);
        if (d.isEmpty()) {
            d = "0.00";
        }
